...
if __name__ == '__main__':
    if len(argv) < 4:
        print("Usage: python %s DATAFILE QUIZFILE OUTPUTFILE" %
              argv[0], file=stderr)
        exit(1)
    ...
    X = train.drop(['16', '7', '56', '57', '35', '32', '31',
                    '29', '2', '11', '9', '0', '5', '14', 'label'], axis=1)
    X_test = test.drop(['16', '7', '56', '57', '35', '32',
                        '31', '29', '2', '11', '9', '0', '5', '14'], axis=1)

    # Binarize select factor variables
    X_dum = pd.get_dummies(
        X, columns=['8', '17', '18', '20', '23', '25', '26', '58'])
    X_dum_test = pd.get_dummies(
        X_test, columns=['8', '17', '18', '20', '23', '25', '26', '58'])
